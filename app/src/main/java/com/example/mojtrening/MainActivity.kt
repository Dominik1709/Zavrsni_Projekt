...
fun LoginScreens() {
    ...
    Column(
        ...
        // Gumb za prijavu
        Button(
            onClick = { /* Dodaj logiku za prijavu */ },
            modifier = Modifier.fillMaxWidth()
        ) {
            Text("Prijavi se")
        }

        // Opcionalno: Dodavanje gumba za registraciju ili zaboravljenu lozinku
        TextButton(onClick = { /* Dodaj logiku za registraciju ili zaboravljenu lozinku */ }) {
